...
- [openzeppelin-contracts](https://github.com/OpenZeppelin/openzeppelin-contracts)
  - The latest version of openzeppelin-contracts has changes in the ERC20Mock file, so you need to install version 4.8.3 by running `forge install openzeppelin/openzeppelin-contracts@v4.8.3 --no-commit`
